# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 18:59:45 2018
...
mulist    = numpy.linspace(4.80 , 4.95, 10)
alphalist = numpy.linspace(1.17, 1.19, 7)
poplist   = [90]
...
cwd = os.getcwd()
filepath = cwd + "/data_test90_2.txt"

if not os.path.isfile(filepath):
    f = open('data_test90_2.txt','w+')
